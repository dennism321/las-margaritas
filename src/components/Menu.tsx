    ...
    items: [
      {
        name: "Botana",
        price: 17,
        desc: "Nachos, cheese quesadilla, chicken flauta, guacamole, sour cream",
      },
      {
      ...
      },
      {
        name: "El Guacamole Especial",
        price: 19,
        desc: "Avocado, onion, tomato, cilantro, and chips",
      },
      ...
      { name: "Super Nachos · Chorizo or Steak", price: 22.79, desc: nachos },
      {
        name: "Chori-queso",
        price: 17.99,
        desc: "Melted cheese with chorizo, served with tortillas",
      },
      {
        name: "Cóctel de Camarón",
        price: 17.99,
        desc: "Mexican-style chilled shrimp cocktail in a tomato-based sauce",
      },
      {
        name: "Ceviche",
        price: 24,
        desc: "Citrus-marinated seafood, served chilled",
      },
      {
        name: "Empanadas",
        price: 15,
        desc: "An order of four crispy empanadas",
      },
      {
        name: "Wings · Half Dozen",
        price: 10.99,
        desc: "Spicy or mild, served with blue cheese",
      },
    ],
  },
  ensaladas: {
    ...
    items: [
      ...
      { name: "Shrimp Taco Salad", price: 26, desc: tacoSalad },
      {
        name: "Garden Salad",
        price: 11.94,
        desc: "Mixed greens, tomatoes, onions, and peppers with your choice of dressing",
      },
    ],
  },
  delmar: {
    ...
    items: [
      {
        name: "Mariscos Combo",
        price: 33,
        desc: "Fish and shrimp sautéed in salsa, with beans, rice, and salad",
      },
      {
      ...
      },
      {
        name: "New York Strip Steak",
        price: 27.95,
        desc: "On a sizzling bed of sautéed onions, with rice & beans or salad",
      },
    ],
  },
  postres: {
    ...
    items: [
      { name: "Flan", price: 6, desc: "Classic Mexican caramel custard" },
      {
        name: "Churros",
        price: 6,
        desc: "Golden and crispy, dusted with cinnamon sugar",
      },
      {
        name: "Tres Leches",
        price: 6,
        desc: "Sponge cake soaked in three milks",
      },
      {
        name: "Fried Ice Cream",
        price: 6,
        desc: "A crispy coating around cold, creamy ice cream",
      },
      {
        name: "Shakes",
        price: 6.95,
        desc: "Mango, passionfruit, chocolate, vanilla, or strawberry",
      },
      {
        name: "Jarritos",
        price: 3.5,
        desc: "Mexican sodas in a variety of flavors",
      },
    ],
  },
};
...
export default function Menu() {
  ...
  // Animate the pill and list only after a visitor switches tabs, not on page load.
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8">
            ...
            <Reveal key={f.name} delay={0.05 + i * 0.08}>
              <article className="group relative h-full overflow-hidden rounded-3xl border border-white/[0.08] bg-night-900/80 transition-all duration-500 hover:-translate-y-2 hover:border-marigold-400/30 hover:shadow-[0_30px_60px_-24px_rgba(0,0,0,0.85)]">
                <div className="relative overflow-hidden">
                  ...
                  {f.tag && (
                    <span className="absolute left-4 top-4 flex items-center gap-1.5 rounded-full glass px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.14em] text-marigold-200">
                      <Star
                        className="h-3 w-3 fill-marigold-400 text-marigold-400"
                        aria-hidden
                      />
                      {f.tag}
                    </span>
                ...
                <div className="p-6">
                  ...
                  <p className="mt-2.5 text-sm leading-relaxed text-cream-300">
                    {f.desc}
                  </p>
                </div>
              </article>
        ...
        <Reveal delay={0.1} className="mt-20">
          <div className="rounded-[2rem] border border-white/[0.08] bg-night-950/60 p-5 sm:p-9">
            ...
            <ul
              key={tab}
              className={`mt-10 grid gap-x-12 sm:grid-cols-2 ${switched ? "anim-rise-in" : ""}`}
            >
            ...
            <p className="mt-8 text-center text-xs font-medium text-cream-500">
              Prices reflect our current menu and may change · Please ask your
              server about allergens.
            </p>
          </div>
        </Reveal>
      </div>
